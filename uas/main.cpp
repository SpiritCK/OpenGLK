    ...
    glUniform3f(LightID, tempLight.x, tempLight.y, tempLight.z);
	  ...
	  glEnableVertexAttribArray(normalAttrib);
		...
		for(int i=0; i<newparticles; i++){
			...
			ParticlesContainer[particleIndex].pos = glm::vec3(1.25f,-0.17f,-0.2f);
			...
			ParticlesContainer[particleIndex].a = 40;

			ParticlesContainer[particleIndex].size = (rand()%1000)/500.0f + 0.1f;
